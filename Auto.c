...
task main() {
	...
	while(true) {
  	...
  	//Joystick 2 - Operator
		...
		//Zip Ties
		if(joystick.joy2_y2 > DEADBAND)		//If the operator is putting in a value on the x-axis of the right stick
			motor[zipties] = 85;					//Make the servo spin accordingly
		else if(joystick.joy2_y2 < -DEADBAND)
			motor[zipties] = -20;
		else
