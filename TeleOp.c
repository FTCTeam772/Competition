...
#pragma config(Motor,  mtr_S1_C3_1,     LeftArmElbow,  tmotorTetrix, PIDControl, encoder)
#pragma config(Motor,  mtr_S1_C3_2,     LeftArmShoulder, tmotorTetrix, PIDControl, encoder)
...
task armControl(){
	while(true) {
		...
		motor[LeftArmShoulder] = arm_scale * joystick.joy2_y1;
		motor[LeftArmElbow] = arm_scale * joystick.joy2_y2;
	}
}
