...
task main() {
  ...
  if(joy1Btn(1) && !joy1Btn(2) && !joy1Btn(4)) {		//bottom
	servo[leftGrab] = 190;
	servo[rightGrab] = 60;
  }  
  if(joy1Btn(3) && !joy1Btn(2) && !joy1Btn(4)) {		//top
	servo[leftGrab] = 0;
	servo[rightGrab] = 270;
  }
  if(joy1Btn(1) && joy1Btn(2) && !joy1Btn(4)) {		//left top only
    servo[leftGrab] = 190;
  }
  if(joy1Btn(1) && !joy1Btn(2) && joy1Btn(4)) {		//left bottom only
    servo[leftGrab] = 0;
  }
  if(joy1Btn(3) && joy1Btn(2) && !joy1Btn(4)) {		//right top only
    servo[rightGrab] = 60;
  }
  if(joy1Btn(3) && !joy1Btn(2) && joy1Btn(4)) {		//right bottom only
    servo[rightGrab] = 270;
  }
		//Joystick 2 - Operator
