...
task armControl(){
	while(true) {
		...
		if(joystick.joy2_y1 > 15 || joystick.joy2_y1 < -15 && (nMotorEncoder[LeftArmShoulder] > ARM_SHOULDER_BOTTOM && nMotorEncoder[LeftArmShoulder] < ARM_SHOULDER_TOP) || joy2Btn(7))
			y1 = joystick.joy2_y1 / 128.0;
		else
			y1 = 0;

		if(joystick.joy2_y2 > 15 || joystick.joy2_y2 < -15 && (nMotorEncoder[LeftArmElbow] > ARM_ELBOW_BOTTOM && nMotorEncoder[LeftArmElbow] < ARM_ELBOW_TOP) || joy2Btn(7))
